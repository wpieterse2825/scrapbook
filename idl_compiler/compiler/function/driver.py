...
from idl_compiler.compiler.function.compiler import IDLFunctionCompiler

class IDLFunctionCompilerProcessor:
    def __init__(self):
        pass
    ...
    def process(self, parsed_arguments):
        ...
        compiler = IDLFunctionCompiler(binary_output, text_input)

        compiler.compile()

if __name__ == "__main__":
    processor = IDLFunctionCompilerProcessor()
