...
from idl_compiler.compiler.structure.compiler import IDLStructureCompiler

class IDLStructureCompilerProcessor:
    def __init__(self):
        pass
    ...
    def process(self, parsed_arguments):
        ...
        compiler = IDLStructureCompiler(binary_output, text_input)

        compiler.compile()

if __name__ == "__main__":
    processor = IDLStructureCompilerProcessor()
