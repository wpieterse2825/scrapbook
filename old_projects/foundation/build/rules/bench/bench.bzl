load("//old_projects/foundation/build/rules/cpp:cpp_binary.bzl", _cpp_binary = "cpp_binary")
load(
    "//old_projects/foundation/build/rules/bench:bench_source.bzl",
...
def bench(
    ...
    _cpp_binary(
        ...
        deps = [
            ":%s" % level_3_operation,
            "//old_projects/foundation/%s/%s/%s/bench_fixtures:%s" % (
                level_1,
                level_2,
                level_3,
                level_3_operation,
