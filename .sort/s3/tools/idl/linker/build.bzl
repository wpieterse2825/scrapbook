...
_EXEC_GROUP_TOOLCHAIN = "//tools/idl/linker:toolchain_type"
...
def _generate_attributes():
    return {
        ...
        "_use_persistent_workers": attr.label(
            default = Label("//tools/idl/linker/archive:use_persistent_workers"),
            providers = [BuildSettingInfo],
        ),
        "_logging_level": attr.label(
            default = Label("//tools/idl/linker/archive:logging_level"),
            providers = [BuildSettingInfo],
        ),
    }
